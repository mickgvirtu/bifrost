...
func TestMidConversationSystemReminderStaysInline(t *testing.T) {
	...
	messages, systemMessages, err := bedrock.ConvertBifrostMessagesToBedrockMessages(context.Background(), input, "us.anthropic.claude-opus-4-8")
	require.NoError(t, err)
...
func TestMidConversationSystemReminderHoistedForNonAnthropic(t *testing.T) {
	...
	messages, systemMessages, err := bedrock.ConvertBifrostMessagesToBedrockMessages(context.Background(), input, "amazon.nova-pro-v1:0")
	require.NoError(t, err)
...
func TestSystemReminderBetweenToolCallAndResult(t *testing.T) {
	...
	messages, _, err := bedrock.ConvertBifrostMessagesToBedrockMessages(context.Background(), input, "us.anthropic.claude-opus-4-8")
	require.NoError(t, err)
